"""
Yet another example program using PyDisp.
"""

# Matto's PyDisp - example 3
# version v0.1.0
#
...
# Modify the color palette for grayscale images
for i in range(16):
	n = i*16 if i != 15 else 255
	display._clr[i] = (n, n, n)
